...
parser.add_argument('--test_list', type=str, default='/data1/cwj/dataset/hmdb51/list_hmdb51_val_hmdb_ucf-feature.txt')
parser.add_argument('--weights', type=str, default='results/src_adv_RGB/model_best.pth.tar')
...
parser.add_argument('--frame_aggregation', type=str, default='trn-m', choices=['avgpool', 'rnn', 'temconv', 'trn-m', 'none'], help='aggregation of frame features (none if baseline_type is not video)')
...
# ========================= Runtime Configs ==========================
parser.add_argument('--save_confusion', type=str, default='results/test-ucf101-hmdb51-full')
parser.add_argument('--save_scores', type=str, default='results/test-ucf101-hmdb51-full')
...
plot_confusion_matrix(args.save_confusion + '.jpg', cf[0], classes=class_names, normalize=True, title='Normalized confusion matrix')
